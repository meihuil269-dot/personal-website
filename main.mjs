...
const lifePhotoIds = Array.from({ length: 117 }, (_, index) => String(index + 1).padStart(3, '0'))
const lifeGalleryGrid = document.querySelector('#life-gallery-grid')
lifeGalleryGrid.innerHTML = lifePhotoIds.map((id) => `<a href="./assets/life-photos-complete/photo-${id}.jpg" target="_blank" rel="noopener noreferrer"><img src="./assets/life-photos-complete/photo-${id}.jpg" loading="lazy" alt="陈璐的生活照片 ${Number(id)}" /></a>`).join('')
